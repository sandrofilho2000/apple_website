                ...
                <div className='flex flex-col justify-center items-center overflow-hidden'>
                    ...
                    <div className="flex-center flex-col sm:px-10">
                        <div className='relative h-[50vh] w-full'>
                            <video playsInline muted autoPlay ref={videoRef} id="exploreVideo" className='w-full h-full object-cover'>
                        ...
                        <div className="feature-text-container">
                            <div className="flex-1 flex-center">
                                <p className="feature-text g_text">
                                    ...
                                    using the same allow that spacecrafts use for missions to Mars
                                </p>
                            </div>
                            <div className="flex-1 flex-center">
                                <p className="feature-text g_text">
                                    Titanium has one of the best strength-to-weith rations of any metal, making these our {''}
                                    <span className="text-white">
